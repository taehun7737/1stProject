...
<link href="${conPath }/css/allView.css" rel="stylesheet">
</head>
<body>
	...
	<c:if test="${not empty daminLoginError }">
		<script>
			alert('${daminLoginError}');
			history.back();
		</script>
	</c:if>
	...
	<div id="content_form">
		<table>
			...
			<tr>
				<c:forEach var="dto" items="${AllView }">
					<td>이름 : ${dto.mName }<br><br> 아이디 : (${dto.mId })</td>
				</c:forEach>
			</tr>
		</table>
		<div class="paging">
